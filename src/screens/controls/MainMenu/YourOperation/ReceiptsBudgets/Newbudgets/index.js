...
const fetchProducts = useCallback(async () => {
  ...
  const handleNext = () => {
    ...
    if (isService) {
      ...
      navigation.navigate('DetailsBudgets', { services: selectedProducts, totalPrice });
    } else {
  ...
  const handleQuantityChange = (id, delta) => {
    ...
    if (selectedItem && selectedItem.categoria === 'Serviços') {
      ...
      navigation.navigate('DetailsBudgets', { services: [selectedService], totalPrice: selectedService.total });
    } else {
