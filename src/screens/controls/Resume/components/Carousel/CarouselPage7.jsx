...
const CarouselPage7 = ({ onNext, onPrevious }) => {
  // Valores iniciais que serão dinâmicos no futuro
  const [saldoAtualizado, setSaldoAtualizado] = useState(1540);
  const [saldoMinimo, setSaldoMinimo] = useState(1530);
